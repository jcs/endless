...
- (void)webView:(UIWebView *)__webView didFailLoadWithError:(NSError *)error
{
    ...
    if (u != nil && [[NSUserDefaults standardUserDefaults] boolForKey:@"allow_tls_error_ignore"]) {
        [uiac addAction:[UIAlertAction actionWithTitle:NSLocalizedString(@"Ignore for this host", nil) style:UIAlertActionStyleDestructive handler:^(UIAlertAction * _Nonnull action) {
